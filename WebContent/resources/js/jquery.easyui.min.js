...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"这是必填项，不能为空",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_437,blur:_43b,mouseenter:_43f,mouseleave:_442,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入一个至少3位的字符串."},url:{validator:function(_462){
...
},message:"请输入一个 {0} 位到 {1}位之间长度的字符串."},remote:{validator:function(_465,_466){
var data={};
data[_466[1]]=_465;
